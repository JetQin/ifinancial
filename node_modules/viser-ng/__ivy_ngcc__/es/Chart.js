...
var Chart = (function () {
    ...
    Chart = __decorate([ __metadata("design:paramtypes", [ChartContext, ElementRef, ViewContainerRef, NgZone])
    ], Chart);
Chart.ɵfac = function Chart_Factory(t) { return new (t || Chart)(ɵngcc0.ɵɵdirectiveInject(ChartContext), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ViewContainerRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone)); };
Chart.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: Chart, selectors: [["v-chart"]], viewQuery: function Chart_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵstaticViewQuery(_c0, true);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.chartDiv = _t.first);
    } }, inputs: { data: "data", height: "height", width: "width", animate: "animate", forceFit: "forceFit", background: "background", plotBackground: "plotBackground", padding: "padding", scale: "scale", theme: "theme", renderer: "renderer", filter: "filter", onMouseDown: "onMouseDown", onMouseMove: "onMouseMove", onMouseLeave: "onMouseLeave", onMouseUp: "onMouseUp", onClick: "onClick", onDblClick: "onDblClick", onTouchStart: "onTouchStart", onTouchMove: "onTouchMove", onTouchEnd: "onTouchEnd", onPlotEnter: "onPlotEnter", onPlotMove: "onPlotMove", onPlotLeave: "onPlotLeave", onPlotClick: "onPlotClick", onPlotDblClick: "onPlotDblClick" }, features: [ɵngcc0.ɵɵProvidersFeature([ChartContext]), ɵngcc0.ɵɵNgOnChangesFeature], decls: 2, vars: 0, consts: [["chartDom", ""]], template: function Chart_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelement(0, "div", null, 0);
    } }, encapsulation: 2 });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(Chart, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: ChartContext }, { type: ɵngcc0.ElementRef }, { type: ɵngcc0.ViewContainerRef }, { type: ɵngcc0.NgZone }]; }, { data: [{
            type: Input
        }], height: [{
            type: Input
        }], width: [{
