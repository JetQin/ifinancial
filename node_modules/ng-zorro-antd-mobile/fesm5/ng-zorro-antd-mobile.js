import { __decorate, __metadata, __param, __values, __assign, __spread, __extends } from 'tslib';
    ...
    StepComponent = StepComponent_1 = __decorate([
        Component({
            ...
            providers: [
                {
                    provide: NG_VALUE_ACCESSOR,
                    useExisting: forwardRef(function () { return StepComponent_1; }),
                    multi: true
                }
            ]
        }),
...
var ActionSheetService = /** @class */ (function (_super) {
    ...
    ActionSheetService$1.ɵprov = ɵɵdefineInjectable({ factory: function ActionSheetService_Factory() { return new ActionSheetService(ɵɵinject(Overlay)); }, token: ActionSheetService, providedIn: "root" });
