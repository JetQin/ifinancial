...
import { Input, HostBinding, Component, NgModule, ViewEncapsulation, TemplateRef, ElementRef, Renderer2, EventEmitter, ViewChild, Output, forwardRef, InjectionToken, Inject, Injectable, Optional, SkipSelf, ApplicationRef, ComponentFactoryResolver, NgZone, HostListener, Pipe, ContentChildren, QueryList, ChangeDetectionStrategy, ChangeDetectorRef, Injector, ViewContainerRef, Directive, ɵɵdefineInjectable, ɵɵinject } from '@angular/core';
...
let ActivityIndicatorModule = class ActivityIndicatorModule {
};
...
__decorate([
    HostBinding('class.am-card-body'),
    __metadata("design:type", Boolean)
...
let CustomKeyboardComponent = class CustomKeyboardComponent {
...
let InputItemModule = class InputItemModule {
};
...
`;
const ɵ0 = svgSprite;
let IconHandler = class IconHandler {
    constructor() {
        this.contents = [];
...
let WingBlankComponent = class WingBlankComponent {
    constructor() {
...
let WingBlankModule = class WingBlankModule {
};
...
let WhiteSpaceComponent = class WhiteSpaceComponent {
    constructor() {
...
let WhiteSpaceModule = class WhiteSpaceModule {
};
...
let BriefComponent = class BriefComponent {
    constructor() {
        this.defaultProps = {
            prefixCls: 'am-list'
        };
...
let SearchBarComponent = SearchBarComponent_1 = class SearchBarComponent {
...
SearchBarComponent = SearchBarComponent_1 = __decorate([
    Component({
        ...
        providers: [
            {
                provide: NG_VALUE_ACCESSOR,
                useExisting: forwardRef(() => SearchBarComponent_1),
                multi: true
            }
        ],
        animations: [
...
let LocaleProviderPipe = class LocaleProviderPipe {
    constructor(_locale) {
...
const ɵ0$1 = zh_CN;
let LocaleProviderModule = class LocaleProviderModule {
};
...
let SearchBarModule = class SearchBarModule {
};
...
let CarouselSlideComponent = class CarouselSlideComponent {
    constructor() {
        this.container = true;
        this.height = 'auto';
...
let DotIndicatorComponent = class DotIndicatorComponent {
    constructor() {
        this.items = [];
        this._page = 0;
        this._pageCount = 0;
...
let RadioItemComponent = class RadioItemComponent {
    constructor(cdr) {
        this.cdr = cdr;
...
let NoticeBarModule = class NoticeBarModule {
};
...
let ToastOptions = class ToastOptions {
};
...
let ModalOptions = class ModalOptions extends ModalBaseOptions {
    constructor() {
        super(...arguments);
...
let AlertOptions = class AlertOptions extends ModalBaseOptions {
};
...
let PopoverOptions = class PopoverOptions {
    constructor() {
...
let PopoverComponentOptions = class PopoverComponentOptions extends PopoverOptions {
};
...
let CalendarWeekPanelComponent = class CalendarWeekPanelComponent {
    constructor() {
...
let DatePickerOptions = class DatePickerOptions {
    constructor() {
        this.mode = 'date';
        this.value = new Date();
...
let DatePickerViewModule = class DatePickerViewModule {
};
...
let CalendarSingleMonthComponent = class CalendarSingleMonthComponent {
...
let PopoverItemModule = class PopoverItemModule {
};
...
let FlexComponent = class FlexComponent {
    constructor() {
        this.defaultProps = {
...
let FlexItemComponent = class FlexItemComponent {
    constructor() {
        this.defaultProps = {
            prefixCls: 'am-flexbox',
            align: 'center'
...
let FlexModule = class FlexModule {
};
...
let TouchFeedbackModule = class TouchFeedbackModule {
};
...
let NgZorroAntdMobilePipesModule = class NgZorroAntdMobilePipesModule {
};
...
let ActionSheetOptions = class ActionSheetOptions {
    constructor() {
...
let ShareOption = class ShareOption {
};
ShareOption = __decorate([
    Injectable()
], ShareOption);
let ShareActionSheetWithOptions = class ShareActionSheetWithOptions extends ActionSheetOptions {
    constructor() {
        super(...arguments);
...
let ActionSheetWithOptions = class ActionSheetWithOptions extends ActionSheetOptions {
};
...
let SegmentedControlModule = class SegmentedControlModule {
};
...
let TextareaItemModule = class TextareaItemModule {
};
...
let TabPaneComponent = class TabPaneComponent {
    constructor() {
        this.isTitleString = true;
    }
    get title() {
...
let TabBarItemComponent = class TabBarItemComponent extends TabPaneComponent {
    constructor() {
        super();
...
let TabBarModule = class TabBarModule {
};
...
let PickerOptions = class PickerOptions {
    constructor() {
        this.data = [];
        this.value = [];
        this.cols = 3;
...
let PickerComponent = class PickerComponent extends PickerRef {
...
let PickerViewModule = class PickerViewModule {
};
...
let SliderTrackComponent = class SliderTrackComponent {
    constructor(_elf, _sanitizer) {
        this._elf = _elf;
        this._sanitizer = _sanitizer;
        this.prefixCls = 'am-slider';
...
let SwipeActionModule = class SwipeActionModule {
};
...
let PullToRefreshModule = class PullToRefreshModule {
};
...
let NgZorroAntdMobileModule = NgZorroAntdMobileModule_1 = class NgZorroAntdMobileModule {
    static forRoot() {
        return {
